<template>
    <div class="content-wrapper bg-background-primary font-sans text-copy-primary leading-normal flex flex-col min-h-screen">
     ...
     <div class="w-3/6 ml-32 sm:mt-0">
        <g-image src="../../static/n5geh.png" alt="hero" class="h-auto mx-auto sm:mx-0"/>
      </div>
                    </li>
                    <li class="mr-8 mb-6 lg:mb-0">
...
<!--                    </li>-->
                    ...
                    <li class="mr-8">
                        <a href="https://git.rwth-aachen.de/EBC/Team_BA/projects/n5geh/n5geh.datamodel" target="_blank" class="text-white hover:text-gray-400">
        ...
        methods: {
            ...
            changeFillColor(e) {
                if(!this.githubLogo && e.target.firstChild)
                    this.githubLogo = e.target.firstChild
                this.githubLogo.style.fill = "currentColor"
            },
            resetFillColor(e) {
                if(!this.githubLogo && e.target.firstChild)
                    this.githubLogo = e.target.firstChild
                this.githubLogo.style.fill = "black"
            }
        }
    }
</script>
