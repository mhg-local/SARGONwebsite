...
const brickClasses = require('./static/ontology/0.1/classes.json')
const brickRelationships = require('./static/ontology/0.1/relationships.json')
const brickNamespaces = require('./static/ontology/0.1/namespaces.json')
